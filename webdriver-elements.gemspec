...
Gem::Specification.new do |s|
  s.name = %q{webdriver-elements}
  s.version = "0.1.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Alexei Barantsev"]
  s.date = %q{2011-02-16}
  s.description = %q{Selenium 2.0 (WebDriver) decorators for web-elements that provides specific methods fot each web-element}
  ...
  s.homepage = %q{http://github.com/barancev/webdriver-elements}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
